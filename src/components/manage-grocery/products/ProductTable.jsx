...
for (let i in orders) {
  orders[i]["imgUri"] =
    "https://s3.amazonaws.com/store-asset/100_80/1656208461-1654653694-Untitled.jpeg";
}
...
const ProductTable = () => {
  ...
  const [orderStatus, setOrderStatus] = useState({ value: 'Stock', label: 'Stock' })
        ...
        <table className="table table-row-dashed">
          <thead>
            <tr className="fw-bolder text-muted">
              ...
              <th className="w-150px">Selling Price</th>
              <th className="w-150px text-center">Variants</th>
              <th className="w-150px text-center">Sort</th>
              <th className="w-100px text-center">Stock</th>
              ...
              orders.map((item) => {
                return (
                  <tr key={item.orderId} className="">
                    ...
                    <td className="text-center">
                     <div className="tbl-input tbl-input-70">
                     <input type="text" name="variant" className="form-control" value="6" placeholder="0" />
                      </div>
                    </td>
                    <td className="text-center">
                     <div className="tbl-input tbl-input-70">
                    ...
                    <td className="text-center">
                     <div className="tbl-input tbl-input-50">
                     <input type="text" name="variant" className="form-control" value="6" placeholder="0" />
                      </div>
                    </td>
                    <td className="text-center"> 
                    <div className="tbl-input tbl-input-50">
                     <input type="text" name="variant" className="form-control" value="1" placeholder="0" />
                      </div>
                      </td>
                      <td className="text-center">
                    ...
                    <td className="">
                      <div className="d-flex justify-content-end align-items-center flex-shrink-0">
                        ...
                        <button className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm prdctshare-main">
                          <span className="svg-icon svg-icon-3">
                          <i class="fa fa-ellipsis-v" aria-hidden="true"></i>
                          </span>
                          <div className="prdctshare-drpdown">
                           <ul>
                            <li><p><em><i class="fa fa-clone" aria-hidden="true"></i></em>Copy Url</p></li>
                            <li><p><em><i class="fa fa-share-alt" aria-hidden="true"></i></em>Share Url</p></li>
                           </ul>
                          </div>
                        </button>
                      </div>
