...
function AddBrandForm({ toggleAddBrandModal, setToggleAddBrandModal }) {
  ...
  return (
    <>
      <div className={`main-popup categry-popup ${toggleAddBrandModal ? 'pop-open' : 'pop-close'}`}>
          ...
          <div className="lm-inner">
            <div className="popup-inner">
              ...
              <div className='popup-body'>
                ...
                <button type="button" className="btn btn-shadow btn-secondary" onClick={() => { setToggleAddBrandModal(p=> !p) }}>Cancel</button></div>
                 </div>
                  </div>
              </div>
        ...
        <div className="overlay" onClick={() => { setToggleAddBrandModal(p=> !p) }}></div>
      </div>
    </>
  )
}
