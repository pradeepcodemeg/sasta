...
import brandImage from '../../../assets/images/britannia.png';
        ...
        <table className="table table-row-dashed">
          <thead>
            <tr className="fw-bolder text-muted">
              ...
              <th className="w-150px">Brand Name</th>
              <th className="w-150px text-center">Brand Image</th>
              <th className="w-70px text-center">Total Products</th>
            ...
            {orders && orders.map((item) => {
              return (
                <tr key={item.orderId} className="">
                  ...
                  <td className="text-center"><span className='prdctimg-bg'><img src={brandImage} /></span></td>
                  ...
                  <div className="d-flex justify-content-end align-items-center flex-shrink-0">
																	...
																	<button  onClick={()=>{setToggleEditBrandModal(p=> !p)}} className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-2">
