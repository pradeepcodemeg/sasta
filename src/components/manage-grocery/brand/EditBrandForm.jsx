...
function EditBrandForm({ toggleEditBrandModal, setToggleEditBrandModal }) {
  ...
  return (
    <>
      <div className={`main-popup categry-popup ${toggleEditBrandModal ? 'pop-open' : 'pop-close'}`}>
            ...
            <div className="popup-inner">
              ...
              <div className='popup-body'>
                  ...
                  <div className="mb-3 fv-row">
                    ...
                    <input type="text" name="Date" value="" className="form-control" placeholder="Enter Brand Title" />
                </div>
                  <div className="mb-3 fv-row ">
                ...
                <button type="button" className="btn btn-shadow btn-secondary" onClick={() => { setToggleEditBrandModal(p=> !p) }}>Cancel</button></div>
                 </div>
                  </div>
              </div>
        ...
        <div className="overlay" onClick={() => { setToggleEditBrandModal(p=> !p) }}></div>
      </div>
    </>
  )
}
