...
const Cartscreen = ({ navigation,route }) => {
    ...
    const gotoadddeliverypartner= (type) =>{
        if(checkdeltprt==type){
            ...
            setdeliveryprt(0); 
            setcoustmpop(0);
            gettotalamountcal(carttotalPrice,handlecrgamt,deliveryfees,donetionfees,0,smallChargesfees,couponamt);
        }
        else{
            ...
            if(type==1){
                setdeliveryprt(10); 
                gettotalamountcal(carttotalPrice,handlecrgamt,deliveryfees,donetionfees,10,smallChargesfees,couponamt);
            }
            else if(type==2){
                setdeliveryprt(20); 
                gettotalamountcal(carttotalPrice,handlecrgamt,deliveryfees,donetionfees,20,smallChargesfees,couponamt);
            }
            else if(type==3){
                setdeliveryprt(30); 
                gettotalamountcal(carttotalPrice,handlecrgamt,deliveryfees,donetionfees,30,smallChargesfees,couponamt);
            }else{
                setdeliveryprt(0); 
            }
        }
            ...
            <View style={{...StylesGloble.container,position:"relative",paddingHorizontal:15}}>
                ...
                <ScrollView  nestedScrollEnabled={true} contentContainerStyle={[checkcartdatav(cartalldata)==true ? styles.pagepadding : styles.nopaddingpage ]} showsVerticalScrollIndicator={false}>
                        ...
                        (checkcartdatav(cartalldata)==true)?(
                            <>
                                ...
                                <View style={{marginTop:20}}>
                                    ...
                                    <View style={{...StylesGloble.oneline,marginTop:15}}>
                                        <View>
                                            <Text style={{fontSize:13,fontWeight:"500",marginTop:0}}>Handling Charge(Max, real)</Text>
                                        </View>
                                        <View style={{...StylesGloble.oneline,marginLeft: "auto"}}>
                                            <Text style={{fontSize:13,fontWeight:"500",color:"#9D9D9D",textDecorationLine:"line-through"}}>₹0</Text>
                                    ...
                                    <View style={{...StylesGloble.oneline,marginTop:15}}>
                                        <View>
                                            <Text style={{fontSize:13,fontWeight:"500",marginTop:0}}>Delivery Fee(Max, real)</Text>
                                        </View>
                                        <View style={{...StylesGloble.oneline,marginLeft: "auto"}}>
                                            <Text style={{fontSize:13,fontWeight:"500",color:"#9D9D9D",textDecorationLine:"line-through"}}>₹0</Text>
                                    ...
                                    <View style={{...StylesGloble.oneline,marginTop:15}}>
                                        <View style={{width:"65%"}}>
                                            <Text style={{fontSize:13,fontWeight:"600",marginTop:0}}>Feeding India Donation should be dynamic according to the param in product API</Text>
                                        </View>
                                        <View style={{...StylesGloble.oneline,marginLeft: "auto"}}>
                                            <TouchableOpacity><Text style={{fontSize:13,fontWeight:"600",color:"#9DC45A"}}>REMOVE  </Text></TouchableOpacity>
                                            <Text style={{fontSize:13,fontWeight:"600",color:"#9D9D9D",textDecorationLine:"line-through"}}>₹0</Text>
                                            <Text style={{fontSize:13,fontWeight:"600",marginLeft:10,marginRight:10}}>₹0</Text>
                                        </View>
                                    </View>
                                    <View style={{...StylesGloble.oneline,marginTop:15}}>
                                        <View>
                                            <Text style={{fontSize:13,fontWeight:"600",marginTop:0}}>Delivery Partner Tip</Text>
                                        </View>
                                        <View style={{...StylesGloble.oneline,marginLeft: "auto"}}>
                                            <Text style={{fontSize:13,fontWeight:"600",color:"#9D9D9D",textDecorationLine:"line-through"}}>₹0</Text>
                                            <Text style={{fontSize:13,fontWeight:"600",marginLeft:10,marginRight:10}}>₹{deliveryprt}</Text>
                                        </View>
                                    </View>
                                    {
                                        (couponamt >0)&&(
                                ...
                                <View style={{marginTop:10}}>
                                    ...
                                    <ScrollView horizontal={true} style={{marginTop:5}} showsHorizontalScrollIndicator={false} > 
                                    {
                                        deliverins.map((item,index)=>{
                                            return <View key={index} style={{width:210,height:110,padding:5,borderColor:"#9D9D9D20",borderRadius:8,borderWidth:1,position:"relative",marginRight:10}}>
                                    ...
                                    (deliveryaddress==0)?(
                                        <View style={{marginTop:10}}>
                                            ...
                                            <View style={{...styles.addressbox}}>
                                                <Text style={{fontSize:18,color:"#000000"}}>{locationname}</Text>
                    ...
                    <Modal animationType="slide" transparent={true} visible={couponPopup}>
                        <TouchableOpacity style={{ position: 'absolute', bottom: 0, width: '100%', height: "100%" }} onPress={() => { setcouponPopup(false); }}>
                            <View  ></View>
                        </TouchableOpacity>
