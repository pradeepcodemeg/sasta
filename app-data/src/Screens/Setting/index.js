    ...
    return (
        <>
            ...
            <Modal animationType="fade" transparent={true} visible={backpopup}>
                ...
                <View style={{ position: "absolute", top: "39%", right: 0, width: wp('90%'),left:wp('5%'), backgroundColor: '#ffffff', borderRadius: 10,  alignItems: "center",elevation:2,padding:30, }}>
                    <View style={{alignItems: "center", height:120 }}>
                        <Image source={imagePath.logout_2} style={{height:40,width:40,marginTop: 1,}}/>
                        <Text style={{ fontSize: 18, fontWeight: "600", color: "#000000",textAlign:"center" ,marginTop:20}}>Are you sure you want to Logout?</Text>
                    </View>
