...
import { Text,Modal,PermissionsAndroid,Image,BackHandler,StyleSheet,View,SafeAreaView,Dimensions,ScrollView, TouchableOpacity} from 'react-native'
            ...
            <View style={styles.container}>
                ...
                <View style={{marginTop:120,marginLeft:12}}>
                    <View style={{marginTop:50}}>
                        {
                            (addresslist !=null)?(
                                <Text style={{fontSize:15,fontWeight:"600",color:"#000000",marginLeft:4}}>Saved Location {selectaddresstate.address}</Text>
                            ):(<></>)
                        }
